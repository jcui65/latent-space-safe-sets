...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/dyn.pth')#'outputs/2023-05-13/12-03-00/3/update_91/dyn.pth')#'outputs/2023-05-07/23-58-12/1/initial_train/dyn.pth')#'outputs/2023-05-12/22-18-44/2/update_6/dyn.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/val.pth')#'outputs/2023-05-13/12-03-00/3/update_91/val.pth')#'outputs/2023-05-07/23-58-12/1/initial_train/val.pth')#'outputs/2023-05-12/22-18-44/2/update_6/val.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/gi.pth')#'outputs/2023-05-13/12-03-00/3/update_91/gi.pth')#'outputs/2023-05-07/23-58-12/1/initial_train/gi.pth')#'outputs/2023-05-12/22-18-44/2/update_6/gi.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--cbfd_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/cbfd_10000.pth')#'outputs/2023-05-13/12-03-00/3/update_91/cbfd.pth')#'outputs/2023-05-08/00-38-51/1/initial_train/cbfd_10000.pth')#'outputs/2023-05-12/22-18-44/2/update_6/cbfd.pth')#'outputs/2023-03-19/00-50-22/1/initial_train/cbfd.pth')#push#'outputs/2023-04-02/01-42-26/1/initial_train/cbfd.pth')#push strategy 2#None)#'outputs/2023-03-15/15-24-59/1/initial_train/cbfd.pth')#reacher1.1#'outputs/2023-03-14/23-29-08/1/initial_train/cbfd.pth')#reacher1.2#
