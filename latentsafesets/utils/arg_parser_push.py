...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2022-07-18/19-38-58/vae.pth',#for pushing#'outputs/2023-02-18/19-47-57/1/vae.pth',#reacher#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default=None)#'outputs/2023-04-27/00-52-54/1/initial_train/ss.pth')#pushing#'outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default=None)#'outputs/2023-04-27/00-52-54/1/initial_train/dyn.pth')#still sample#'outputs/2023-05-13/12-03-00/3/update_91/dyn.pth')#'outputs/2023-05-07/23-58-12/1/initial_train/dyn.pth')#'outputs/2023-05-12/22-18-44/2/update_6/dyn.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default=None)#'outputs/2023-04-27/00-52-54/1/initial_train/val.pth')#still sample#'outputs/2023-05-13/12-03-00/3/update_91/val.pth')#'outputs/2023-05-07/23-58-12/1/initial_train/val.pth')#'outputs/2023-05-12/22-18-44/2/update_6/val.pth')#'outputs/2023-04-27/00-52-54/1/initial_train/val.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default=None)#'outputs/2023-04-27/00-52-54/1/initial_train/constr.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#reacher#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default=None)#'outputs/2023-04-27/00-52-54/1/initial_train/gi.pth')#still sample#'outputs/2023-05-13/12-03-00/3/update_91/gi.pth')#'outputs/2023-05-07/23-58-12/1/initial_train/gi.pth')#'outputs/2023-05-12/22-18-44/2/update_6/gi.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--w1',type=float,default=1000)#10000)#
    parser.add_argument('--w2',type=float,default=1000)#10000)#
    parser.add_argument('--w3',type=float,default=3000)#1)
    parser.add_argument('--w4',type=float,default=20000)#10)#20)#
    parser.add_argument('--w5',type=float,default=0)
    parser.add_argument('--w6',type=float,default=15000)#10000)
    parser.add_argument('--w7',type=float,default=10000)#10000)
    ...
    parser.add_argument('--stepstohell',type=float,default=6)#10)#5)#
    parser.add_argument('--rewrite',type=str,default='no')#'yes')#
    parser.add_argument('--unsafethressmall',type=float,default=0.10)#
