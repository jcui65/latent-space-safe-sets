...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--cbfd_init_iters', type=int, default=200000,#100000,#50000,#10000,#1,#to test RLSA#2000,#4001,#20000,#40000,#80000,#640000,#320000,#200000,#10000,#30000,#160000,#100000,#1000,#
                        help='Initial training iterations')
