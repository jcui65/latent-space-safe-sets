...
def parse_args():
    ...
    parser.add_argument('--traj_per_update', default=10, type=int)#2, type=int)#
    parser.add_argument('--num_updates', type=int, default=100)#2)#25)#1)#10)#200)#250)#50)#150)#500)#1500)#75)##45)#40)#35)#5)#20)#15)#30)#the default is 25#
    parser.add_argument('--exper_name', type=str, default=None)
    parser.add_argument('--repeat_times',type=int,default=1)#3)#7)#
    ...
    parser.add_argument('--datasetnumber',type=int,default=2)#1)#1 for old data, 2 for new data, 3 for data 3!
    parser.add_argument('--vaesnumber',type=str,default='d2v1')#'d1v1')#divi means dataset i vae i, 'no' means no pretrain
...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_init_iters', type=int, default=1000,#100000,
                        help='Initial training iterations')
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2023-04-12/02-17-10/vae.pth',#'outputs/2022-07-18/19-38-58/vae.pth',#for pushing#'outputs/2023-02-18/19-47-57/1/vae.pth',#reacher#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default='outputs/2023-04-12/03-30-11/1/initial_train/ss.pth')#baby push#'outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-04-12/03-30-11/1/initial_train/dyn.pth')#baby push#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-04-12/03-30-11/1/initial_train/val.pth')#baby push#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default='outputs/2023-04-12/03-30-11/1/initial_train/constr.pth')#baby push#'outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#reacher#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-04-12/03-30-11/1/initial_train/gi.pth')#baby push#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--cbfd_checkpoint', type=str, default='outputs/2023-04-12/03-30-11/1/initial_train/cbfd.pth')#baby push#'outputs/2023-04-02/01-42-26/1/initial_train/cbfd.pth')#pushing#None)#'outputs/2023-03-19/00-50-22/1/initial_train/cbfd.pth')#pushing#'outputs/2023-03-15/15-24-59/1/initial_train/cbfd.pth')#reacher1.1#'outputs/2023-03-14/23-29-08/1/initial_train/cbfd.pth')#reacher1.2#
