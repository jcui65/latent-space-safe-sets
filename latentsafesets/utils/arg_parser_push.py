...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2022-07-18/19-38-58/vae.pth',#for pushing#'outputs/2023-04-12/02-17-10/vae.pth',#'outputs/2023-02-18/19-47-57/1/vae.pth',#reacher#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#push#'outputs/2023-04-12/03-30-11/1/initial_train/ss.pth')#baby push#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#push#'outputs/2023-04-12/03-30-11/1/initial_train/dyn.pth')#baby push#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#push#'outputs/2023-04-12/03-30-11/1/initial_train/val.pth')#baby push#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#push#''outputs/2023-04-12/03-30-11/1/initial_train/constr.pth')#baby push#outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#reacher#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#push#'outputs/2023-04-12/03-30-11/1/initial_train/gi.pth')#baby push#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--cbfd_checkpoint', type=str, default='outputs/2023-03-19/00-50-22/1/initial_train/cbfd.pth')#push#'outputs/2023-04-12/03-30-11/1/initial_train/cbfd.pth')#baby push#'outputs/2023-04-02/01-42-26/1/initial_train/cbfd.pth')#pushing#None)#'outputs/2023-03-15/15-24-59/1/initial_train/cbfd.pth')#reacher1.1#'outputs/2023-03-14/23-29-08/1/initial_train/cbfd.pth')#reacher1.2#
