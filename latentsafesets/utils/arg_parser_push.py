...
def parse_args():
    ...
    parser.add_argument('--seed', type=int, default=3, help='Random seed')#2, help='Random seed')#1, help='Random seed')#4, help='Random seed')#-1, help='Random seed')#
    ...
    parser.add_argument('--repeat_times',type=int,default=1)#3)#2)#7)#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/ss.pth')#pushing#'outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/dyn.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/val.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/constr.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#reacher#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-04-27/00-52-54/1/initial_train/gi.pth')#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#
