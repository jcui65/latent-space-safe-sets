...
def parse_args():
    ...
    parser.add_argument('--num_updates', type=int, default=250)#500)#200)#1500)#75)#150)#50)##25)#45)#40)#35)#5)#20)#15)#10)#30)#the default is 25#
