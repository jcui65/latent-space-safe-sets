...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2022-07-13/17-24-59/vae.pth',#'outputs/2023-02-04/15-01-49/vae.pth',#None,#'outputs/2022-11-13/15-19-54/vae.pth',#planaego#'outputs/2023-01-30/01-25-33/vae.pth',#new 5
    ...
    parser.add_argument('--enc_checkpoint2', type=str, default='outputs/2022-07-13/17-24-59/vae.pth',#'outputs/2022-11-13/15-19-54/vae.pth',#it is using ego coordinates#'outputs/2022-07-13/17-24-59/vae.pth',#it is using global coordinates#
                        help='File to load a CEM model from')  #
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint2', type=str, default='outputs/2022-12-26/22-29-25/initial_train/dyn.pth')#None)#planaego#'outputs/2023-01-30/10-24-14/initial_train/dyn.pth')#'outputs/2022-12-26/11-14-08/initial_train/dyn.pth')#'outputs/2022-12-03/15-32-41/initial_train/dyn.pth')#'outputs/2022-11-21/11-01-14/initial_train/dyn.pth')#'outputs/2022-11-19/10-32-29/initial_train/dyn.pth')#'outputs/2022-07-15/17-41-16/initial_train/dyn.pth')#'outputs/2022-08-07/01-56-19/update_3/dyn.pth')#'outputs/2022-08-07/01-36-19/update_4/dyn.pth')#'outputs/2022-08-07/01-09-48/update_5/dyn.pth')#
...
def add_cbfd_args(parser):
    # Constraint Estimator params
    parser.add_argument('--cbfdot_thresh', type=float, default=1.0)#838860.8)#209715.2)#819.2)#3.2)#214748364.8)#53687091.2)#13421772.8)#3355443.2)#52428.8)#13107.2)#3276.8)#204.8)#51.2)#12.8)#0.8)#
    parser.add_argument('--cbfdot_thresh_mult', type=float, default=1.0)#1.25)#0.8)#
