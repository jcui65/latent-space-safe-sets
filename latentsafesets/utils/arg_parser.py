...
def parse_args():
    ...
    parser.add_argument('--num_updates', type=int, default=100)#150)#200)#10)#25)#250)#500)#1500)#75)#50)##45)#40)#35)#5)#20)#15)#30)#the default is 25#
...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2022-07-13/17-24-59/vae.pth',#''outputs/2022-11-13/15-19-54/vae.pth',#outputs/2022-11-21/01-35-45/vae.pth',#None,#plan b relative var 1#'outputs/2022-11-27/08-55-19/vae.pth',#None,#'outputs/2022-11-23/10-53-55/vae.pth',#plan b relative var 0.01#'outputs/2022-11-25/01-29-50/vae.pth',#plan b global coordinates, var=0.01#'outputs/2022-11-25/19-17-37/vae.pth',#plan b global coordinates, var=1#
