...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2022-07-18/19-38-58/vae.pth',#for pushing#'outputs/2023-02-18/19-47-57/1/vae.pth',#reacher#'outputs/2023-02-18/19-47-57/1/vae_72000.pth',#None,#'outputs/2022-07-13/17-24-59/vae.pth',#'outputs/2023-02-16/21-43-17/vae.pth',#global#'outputs/2023-02-16/21-42-26/vae.pth',#relative#None,#'outputs/2023-02-04/15-01-49/vae.pth',#'outputs/2022-11-13/15-19-54/vae.pth',#planaego#'outputs/2023-01-30/01-25-33/vae.pth',#new 5
...
def add_cbfd_args(parser):
    # Constraint Estimator params
    parser.add_argument('--cbfdot_thresh', type=float, default=0.4)#0.6)#0.8)#1.0)#0.48)#838860.8)#209715.2)#819.2)#3.2)#214748364.8)#53687091.2)#13421772.8)#3355443.2)#52428.8)#13107.2)#3276.8)#204.8)#51.2)#12.8)#0.8)#
