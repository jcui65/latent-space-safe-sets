...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint2', type=str, default='outputs/2022-11-13/15-19-54/vae.pth',#it is using ego coordinates#'outputs/2022-07-13/17-24-59/vae.pth',#it is using global coordinates#
                        help='File to load a CEM model from')  #
