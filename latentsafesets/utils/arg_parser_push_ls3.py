...
def parse_args():
    ...
    parser.add_argument('--env', type=str, default='push')
    ...
    parser.add_argument('--num_updates', type=int, default=100)#1)#25)#10)#200)#2)#250)#50)#150)#500)#1500)#75)##45)#40)#35)#5)#20)#15)#30)#the default is 25#
    ...
    parser.add_argument('--vaesnumber',type=str,default='d2v1')#divi means dataset i vae i
...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2022-07-18/19-38-58/vae.pth',#for pushing#'outputs/2023-04-01/19-56-57/vae.pth',#for new pushing#'outputs/2023-02-18/19-47-57/1/vae.pth',#reacher#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#old pushing#'outputs/2023-04-07/22-13-32/1/initial_train/ss.pth')#real new push!#'outputs/2023-04-06/16-39-34/1/initial_train/ss.pth')#new push#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#old pushing#'outputs/2023-04-07/22-13-32/1/initial_train/dyn.pth')#real new push!#'outputs/2023-04-06/16-39-34/1/initial_train/dyn.pth')#new push#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#old pushing#'outputs/2023-04-07/22-13-32/1/initial_train/val.pth')#real new push!#'outputs/2023-04-06/16-39-34/1/initial_train/val.pth')#new push#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#old pushing#'outputs/2023-04-07/22-13-32/1/initial_train/constr.pth')#real new push!#'outputs/2023-04-06/16-39-34/1/initial_train/constr.pth')#new push#'outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#reacher#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#old pushing#'outputs/2023-04-07/22-13-32/1/initial_train/gi.pth')#real new push!#'outputs/2023-04-06/16-39-34/1/initial_train/gi.pth')#new push#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--cbfd_checkpoint', type=str, default=None)#'outputs/2023-03-19/00-50-22/1/initial_train/cbfd.pth')#pushing#'outputs/2023-03-15/15-24-59/1/initial_train/cbfd.pth')#reacher1.1#'outputs/2023-03-14/23-29-08/1/initial_train/cbfd.pth')#reacher1.2#
