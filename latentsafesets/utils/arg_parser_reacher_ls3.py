...
def parse_args():
    ...
    parser.add_argument('--repeat_times',type=int,default=3)#5)#4)#1)#10)#7)#2)#
    ...
    parser.add_argument('--datasetnumber',type=int,default=3)#1 for old data, 2 for new data, 3 for data 3!
    parser.add_argument('--vaesnumber',type=str,default='d1v1')#divj means dataset i vae j, noj means no pretrain, while only taking the jth vae of the dataset
...
def add_controller_args(parser):
    ...
    parser.add_argument('--conservative', type=str, default='average')#'conservative')#'onestd')#
...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2023-04-29/18-08-38/vae.pth',#'outputs/2023-02-18/19-47-57/1/vae.pth',#old reacher#'outputs/2023-04-05/19-29-19/vae.pth',#new reacher#'outputs/2023-04-08/02-02-17/vae.pth',#new 2 reacher#'outputs/2023-04-08/01-57-17/vae.pth',#old 2 reacher#'outputs/2023-02-18/19-47-57/1/vae.pth',#old reacher#'outputs/2022-07-18/19-38-58/vae.pth',#for pushing#
                        #None,#'outputs/2023-02-18/19-47-57/1/vae_72000.pth',#'outputs/2022-07-13/17-24-59/vae.pth',#'outputs/2023-02-16/21-43-17/vae.pth',#global#'outputs/2023-02-16/21-42-26/vae.pth',#relative#None,#'outputs/2023-02-04/15-01-49/vae.pth',#'outputs/2022-11-13/15-19-54/vae.pth',#planaego#'outputs/2023-01-30/01-25-33/vae.pth',#new 5
    ...
    parser.add_argument('--enc_checkpoint2', type=str, default=None,#'outputs/2022-07-13/17-24-59/vae.pth',#'outputs/2022-11-13/15-19-54/vae.pth',#it is using ego coordinates#'outputs/2022-07-13/17-24-59/vae.pth',#it is using global coordinates#
                        help='File to load a CEM model from')  #
    parser.add_argument('--mean',type=str,default='sample')#'mean')#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default='outputs/2023-05-01/01-00-32/1/initial_train/ss.pth')#'outputs/2023-04-30/02-35-05/1/initial_train/ss.pth')#'outputs/2023-04-07/19-43-49/1/initial_train/ss.pth')#really new reacher#'outputs/2023-04-08/12-42-19/1/initial_train/ss.pth')#new 2 reacher#'outputs/2023-04-08/12-39-06/1/initial_train/ss.pth')#old 2 reacher#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#old reacher#'outputs/2023-04-06/06-04-22/1/initial_train/ss.pth')#new reacher#'outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#pushing#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-05-01/01-00-32/1/initial_train/dyn.pth')#'outputs/2023-04-30/02-35-05/1/initial_train/dyn.pth')#'outputs/2023-04-07/19-43-49/1/initial_train/dyn.pth')#really new reacher#'outputs/2023-04-08/12-42-19/1/initial_train/dyn.pth')#new 2 reacher#'outputs/2023-04-08/12-39-06/1/initial_train/dyn.pth')#old 2 reacher#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#old reacher#'outputs/2023-04-06/06-04-22/1/initial_train/dyn.pth')#new reacher#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-05-01/01-00-32/1/initial_train/val.pth')#'outputs/2023-04-30/02-35-05/1/initial_train/val.pth')#'outputs/2023-04-07/19-43-49/1/initial_train/val.pth')#really new reacher#'outputs/2023-04-08/12-42-19/1/initial_train/val.pth')#new 2 reacher#'outputs/2023-04-08/12-39-06/1/initial_train/val.pth')#old 2 reacher#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#old reacher#'outputs/2023-04-06/06-04-22/1/initial_train/val.pth')#new reacher#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default='outputs/2023-05-01/01-00-32/1/initial_train/constr.pth')#'outputs/2023-04-30/02-35-05/1/initial_train/constr.pth')#'outputs/2023-04-07/19-43-49/1/initial_train/constr.pth')#really new reacher#'outputs/2023-04-08/12-42-19/1/initial_train/constr.pth')#new 2 reacher#'outputs/2023-04-08/12-39-06/1/initial_train/constr.pth')#old 2 reacher#'outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#old reacher#'outputs/2023-04-06/06-04-22/1/initial_train/constr.pth')#new reacher#'outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#pushing#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-05-01/01-00-32/1/initial_train/gi.pth')#'outputs/2023-04-30/02-35-05/1/initial_train/gi.pth')#'outputs/2023-04-07/19-43-49/1/initial_train/gi.pth')#really new reacher#'outputs/2023-04-08/12-42-19/1/initial_train/gi.pth')#new 2 reacher#'outputs/2023-04-08/12-39-06/1/initial_train/gi.pth')#old 2 reacher#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#old reacher#'outputs/2023-04-06/06-04-22/1/initial_train/gi.pth')#new reacher#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#
