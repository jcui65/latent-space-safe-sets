...
def parse_args():
    ...
    parser.add_argument('--ftk',type=int,default=50)#25)#
...
def add_encoder_args(parser):
    ...
    parser.add_argument('--enc_checkpoint', type=str, default='outputs/2023-04-29/18-08-38/vae.pth',#'outputs/2023-02-18/19-47-57/1/vae.pth',#reacher#'outputs/2022-07-18/19-38-58/vae.pth',#for pushing#
                        #None,#'outputs/2023-02-18/19-47-57/1/vae_72000.pth',#None,#'outputs/2022-07-13/17-24-59/vae.pth',#'outputs/2023-02-16/21-43-17/vae.pth',#global#'outputs/2023-02-16/21-42-26/vae.pth',#relative#None,#'outputs/2023-02-04/15-01-49/vae.pth',#'outputs/2022-11-13/15-19-54/vae.pth',#planaego#'outputs/2023-01-30/01-25-33/vae.pth',#new 5
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--cbfd_init_iters', type=int, default=100000,#6002,#50000,#10000,#1,#to test RLSA#2000,#4001,#20000,#40000,#80000,#640000,#320000,#200000,#10000,#30000,#160000,#100000,#1000,#
                        help='Initial training iterations')
    ...
    parser.add_argument('--cbf_thresh_mult_iters', type=int, default=2)#3)#5)#8)#16)#16 is crazy, but fails#
    ...
    parser.add_argument('--pdnthres',type=float,default=1e-5)#0.002#
...
def add_env_options(params):
    ...
    if params['env'] == 'spb':
        ...
        params['buffer_size'] = params['ftk']*1000#25000#75000#
        #params['data_dirs'] = [
            #'Reacher',
            #'ReacherConstraints',
            #'ReacherInteractions',
