...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default=None)#'outputs/2023-04-30/02-35-05/1/initial_train/ss.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/ss.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#pushing#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default=None)#'outputs/2023-04-30/02-35-05/1/initial_train/dyn.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/dyn.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default=None)#'outputs/2023-04-30/02-35-05/1/initial_train/val.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/val.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default=None)#'outputs/2023-04-30/02-35-05/1/initial_train/gi.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/gi.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#
