...
def parse_args():
    ...
    parser.add_argument('--repeat_times',type=int,default=2)#3)#1)#5)#10)#7)#
...
def add_ss_args(parser):
    ...
    parser.add_argument('--safe_set_checkpoint', type=str, default='outputs/2023-04-30/02-35-05/1/initial_train/ss.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/ss.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/ss.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/ss.pth')#pushing#
...
def add_dyn_args(parser):
    ...
    parser.add_argument('--dyn_checkpoint', type=str, default='outputs/2023-04-30/02-35-05/1/initial_train/dyn.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/dyn.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/dyn.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/dyn.pth')#pushing#
...
def add_val_args(parser):
    ...
    parser.add_argument('--val_checkpoint', type=str, default='outputs/2023-04-30/02-35-05/1/initial_train/val.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/val.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/val.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/val.pth')#pushing#
...
def add_constr_args(parser):
    ...
    parser.add_argument('--constr_checkpoint', type=str, default='outputs/2023-04-30/02-35-05/1/initial_train/constr.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/constr.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/constr.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/constr.pth')#pushing#
...
def add_gi_args(parser):
    ...
    parser.add_argument('--gi_checkpoint', type=str, default='outputs/2023-04-30/02-35-05/1/initial_train/gi.pth')#mean!#'outputs/2023-05-01/01-00-32/1/initial_train/gi.pth')#sample!#'outputs/2023-02-19/16-20-28/1/initial_train/gi.pth')#reacher#'outputs/2023-02-21/09-18-27/1/initial_train/gi.pth')#pushing#
...
def add_cbfd_args(parser):
    ...
    parser.add_argument('--dhdmax',type=float,default=0.005)#
    ...
    parser.add_argument('--unsafebuffer',type=str,default='yes')#'no')#
