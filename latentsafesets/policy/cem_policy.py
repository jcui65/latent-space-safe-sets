...
class CEMSafeSetPolicy(Policy):
    def __init__(self, env: gym.Env,
        ...
        self.ignore_safe_set = True#False#params['safe_set_ignore']#False, for ablation study!#changed to true after using cbf dot
        self.ignore_constraints = True#False#params['constr_ignore']#false
        self.ignore_cbfdots = False#params['cbfd_ignore']  #True#True# false
