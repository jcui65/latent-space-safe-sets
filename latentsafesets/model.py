...
class GenericNetcbfelu(nn.Module):

    def __init__(self, d_in, d_out, n_hidden=2, d_hidden=128, activation=nn.ELU,
                 last_activation=None, **kwargs):
        super(GenericNetcbfelu, self).__init__()
