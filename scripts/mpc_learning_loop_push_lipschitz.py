        ...
        for i in range(num_updates):#default 25 in spb
            ...
            for j in range(traj_per_update):#default 10 in spb
                ...
                for k in trange(params['horizon']):#default 100 in spb#This is MPC
                    ...
                    log.info('a1:%f,a2:%f'%(action[0],action[1]))
                    ...
                    log.info('ho: %f, hno: %f'%(hobs,hnextobs))
                    ...
                    if posdiffnorm<params['pdnthres']:#1e-3:#5e-4:#2e-3:#1e-2:#posdiffnorm<=1e-4:#otherwise it is meaningless!
                        imagediffnormal=0
                        zdiffnorm=0
                        hdiffnorm=0
                        qdiffnorm=0
