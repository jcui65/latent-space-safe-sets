    ...
    for i in range(num_updates):#default 25 in spb
        ...
        for j in range(traj_per_update):#default 10 in spb
            ...
            for k in trange(params['horizon']):#default 100 in spb#This is MPC
                ...
                action, tp, fp, fn, tn, tpc, fpc, fnc, tnc = policy.actcbfdsquarelatentplanai(obs / 255, env.state, tp,fp,# obs_relative / 255, env.state, tp, fp,#
                                                                                             fn, tn, tpc, fpc, fnc, tnc,i)
                action, tp, fp, fn, tn, tpc, fpc, fnc, tnc = policy.actcbfdsquarelatentplanaicbfqp(obs / 255, env.state, tp,fp,# obs_relative / 255, env.state, tp, fp,#
                                                                                              fn, tn, tpc, fpc, fnc,tnc, i)
